/* $Id: ctabs.c,v 1.1 2006/09/15 22:24:35 Administrator Exp $ */
/*
...
{
    int symbol;
    char line[1024 +              /* extra space for non terminals */
			  SYMBOL_SIZE +       /* max length of a token symbol  */
	...
	for ALL_NON_TERMINALS(symbol)
	{
        ...
        sprintf(line, "      %s%s = %i,\n\0",  nt_prefix, tok, symbol_map[symbol] - num_terminals);
