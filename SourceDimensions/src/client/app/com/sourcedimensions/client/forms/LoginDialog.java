...
public class LoginDialog
{
	...
	private void createShell(Shell parent) 
	{
		...
		m_shell.setSize(new Point(277, 151));
		...
		m_cancelButton.setLocation(new Point(147, 85));
